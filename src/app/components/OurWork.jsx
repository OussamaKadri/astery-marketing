...
{/* case studies 01 */}
 ...
 <div className=' IBM text-white font-bold text-[27px] py-2 border-white border-b-2 '> 8 To 24 Client In less Than 2 Months</div>
<div className=' text-start px-4 border-b-2 border-white '>
    <p className=' font-extralight text-white text-[22px] '>Channels</p>
