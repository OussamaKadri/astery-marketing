...
< Link href="Lead_Magnet" className=' mt-8 bg-[#4b73f8] text-white lg:px-6 px-3  py-2 hover:bg-[#1f53ffc5] hover:text-slate-300 rounded-lg Bur '>Up to 11 for free</Link>
  </div>
